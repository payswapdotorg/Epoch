/**
 * Dependency-free SHA-256 (FIPS 180-4), hex output.
 *
 * Used for snapshot content digests (exact-revision identity) and derived
 * relation ids. Pure TypeScript over TextEncoder UTF-8 — identical results
 * in Node and browsers. Correctness is pinned in tests against NIST
