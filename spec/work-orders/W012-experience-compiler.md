# W012 — Experience Compiler
Status: AUTHORIZED (wave 5; dispatch base recorded in the live dispatch issue)
Depends On: W011
Worker Count: 1

## Owned write surfaces
- `packages/experience-compiler/*`
- `contracts/experience-compiler/*`

## Objective
Implement Experience Compiler exactly within frozen Epoch E1.0/X1.0 contracts. Consume upstream interfaces; do not redefine their authority.
