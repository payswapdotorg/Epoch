# W021 — Simulation Execution Fabric
Status: READY_AFTER_DEPENDENCIES
Depends On: W005,W007,W020
Worker Count: 1

## Owned write surfaces
- `services/simulation-runner/*`
- `packages/simulation-fabric/*`

## Objective
Implement Simulation Execution Fabric inside the frozen architecture, using upstream contracts rather than recreating authorities.
